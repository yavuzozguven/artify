...
abstract class ImageUtils {
    companion object {
         ...
         */
        fun decodeBitmap(file: File,exif:android.media.ExifInterface,bitmap:Bitmap): Bitmap {
            ...
            return Bitmap.createBitmap(
                bitmap2,
                0, 0, bitmap.width-1, bitmap.height-1, transformation, true
            )
        }
        ...
        fun scaleBitmapAndKeepRatio(
            ...
            var bmp = Bitmap.createBitmap(targetBmp, 0, 0,
                targetBmp.width,
